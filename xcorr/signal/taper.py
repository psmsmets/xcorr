...
def window(
    x: xr.DataArray, wtype: str = 'hann',
    max_percentage: float = None, max_length: float = None,
    side: str = None
):
    r"""Return a Hann window for a coordinate of N-D labeled array of data.
